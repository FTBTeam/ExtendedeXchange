...
public class AlchemyTableScreen extends AbstractEXScreen<AlchemyTableMenu, AlchemyTableBlockEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(ExtendedExchange.MOD_ID, "textures/gui/alchemy_table.png");
